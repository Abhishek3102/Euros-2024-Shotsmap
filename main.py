...
if plot_type == "Shot Map":
    ...
    # Show shot techniques and types for selected player
    if player:
        player_details = filtered_df[['shot_technique', 'shot_outcome', 'shot_type']]
        st.write(f"### {player}'s Shot Techniques and Types")
